...
3.  mutate : buat kolom baru atau replace isi semua baris pada suatu
    kolom
4.  group\_by: data di kelompokkan contoh diatas berdasarkan bulan pada
    kolom month
5.  summarise : buat tabel summary, yang contoh diatas adalah summary
    rata-rata kecepatan angin dan tekanan
